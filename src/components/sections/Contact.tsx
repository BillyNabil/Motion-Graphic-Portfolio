...
const socialLinks = [
  ...
  {
    name: 'Instagram',
    url: 'https://instagram.com/billynabil',
    icon: (
  ...
  {
    name: 'X (Twitter)',
    url: 'https://twitter.com/billynabil',
    icon: (
  ...
  {
    name: 'Discord',
    url: 'https://discord.gg/billynabil',
    icon: (
      <svg viewBox="0 0 24 24" className="w-6 h-6" fill="currentColor">
    ...
    <section id="contact" className="py-20 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="text-center mb-16"
        >
          <div className="bg-gradient-to-r from-primary/10 to-secondary/10 p-12 rounded-2xl border">
            ...
            <div className="flex justify-center items-center space-x-8">
              {socialLinks.map((social, index) => (
                ...
                >
                  <div className="p-3 rounded-full bg-muted/50 hover:bg-muted transition-colors duration-200">
                    {social.icon}
                  </div>
